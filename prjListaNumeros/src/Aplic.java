    ...
    public static void main(String[] args) {
        ...
        switch(op){
            ...
            case 1: System.out.println("Soma da Matriz = " + lisNum.calcSomatoria());
                    break;
            case 2: System.out.println("Média da Matriz = " + lisNum.calcMedia());
                    break;
            case 3: System.out.println("Maior valor da Matriz = " + lisNum.pesqMaior());
                    break;
            case 4: System.out.println("Menor valor da Matriz = " + lisNum.pesqMenor());
                    break;
            case 5: for(i = 0; i < lisNum.getQtdeElem(); i++){
                        System.out.println("Valor = " + lisNum.getMatNum()[i]);
                    }
                    break;
        }
        }while(op < 6);
