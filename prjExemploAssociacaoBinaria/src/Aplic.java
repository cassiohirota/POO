...
public class Aplic {
    public static void main(String[] args) {
        Projeto proj = new Projeto(100, "Testes");
        proj.setDtInicio("2010");
        proj.setDtTermino("2015");
       ...
       //1 objeto da classe Departamento
        ...
        System.out.println("O funcionário " + funcHor.getNome() + " trabalha no departamento de " + funcHor.getDepartamento().getNome());
       ...
       System.out.println("O funcionário " + funcMen.getNome() + " trabalha no departamento de " + funcMen.getDepartamento().getNome());
       ...
       System.out.println("O funcionário " + funcCom.getNome() + " trabalha no departamento de " + funcCom.getDepartamento().getNome());
